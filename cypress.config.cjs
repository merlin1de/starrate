module.exports = {
  e2e: {
    baseUrl: process.env.CYPRESS_NC_URL || process.env.NC_URL || 'https://nextcloud.example.com',
    ...
    env: {
      NC_URL:    process.env.CYPRESS_NC_URL    || process.env.NC_URL    || 'https://nextcloud.example.com',
